...
urlpatterns = [
    ...
    url(r'^setup_new_account/$', new_manager_user_setup, name='new_manager_user_setup'),
    ...
    url(r'^email_change_confirm/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/(?P<new_email>[^@]+@[^@]+\.[^@]+)/$', email_change_confirm, name='email_change_confirm'),
    url(r'^account_email_change_sent/$', account_email_change_sent, name='account_email_change_sent'),
